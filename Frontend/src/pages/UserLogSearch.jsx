...
//   /* ---------- SEARCH ---------- */
//   const searchLogs = async (targetPage = 1) => {
...
//         page: targetPage,
//         page_size: pageSize,
//         scope: filters.scope, // 🔥 SEND TO BACKEND
//       };
...
//                   {logs.map((l) => (
//                     <tr key={l.log_id}>
//                       <td>{new Date(l.log_timestamp).toLocaleString()}</td>
//                       <td>{l.severity_code}</td>
//                       <td>{l.host_name || "—"}</td>
