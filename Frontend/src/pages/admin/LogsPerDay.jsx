...
// //                 <tr key={i}>
// //                   <td>{row.date}</td>
// //                   <td className="text-end">{row.total_logs}</td>
// //                 </tr>
// //               ))
// //             )}
// //           </tbody>
...
//   // keep UI dates in YYYY-MM-DD (required for <input type="date">)
...
//   /* ================= HELPERS ================= */
//   // convert UI date → backend expected format (DD-MM-YYYY)
...
//     // logical validation only (no UI blocking)
//     if (startDate && endDate && startDate > endDate) {
//       alert("Start date cannot be after end date");
//       return;
//     }

//     setRange("all"); // disable preset range
//     setPage(1);
//     loadData();
//   };
...
//             Filter logs by a specific day or date range
//           </div> */}
//         </div>
//       </div>
